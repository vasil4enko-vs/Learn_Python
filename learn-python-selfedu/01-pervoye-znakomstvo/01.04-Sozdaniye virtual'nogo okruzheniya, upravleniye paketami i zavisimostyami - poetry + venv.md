...
Можно создать виртуальную среду и, непосредственно, из директории проекта, для этого переходим в неё и выполняем команду:
...
**Важный момент**. Так как, мы установили при помощи **pyenv** для нашего проекта версию Python 3.11.3, то и виртуальное окружение создалось с той же версией. Точнее в директории `venv/bin`, были созданы ссылки на установленную нами ранее версию Python.
...
```bash
['/home/user/.pyenv/versions/3.11.3/lib/python3.11/site-packages']
```
